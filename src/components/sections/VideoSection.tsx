  ...
  return (
    <SectionWrapper bgColor="bg-bg-light">
      ...
      <AnimatedSection>
        ...
        <div className="max-w-[900px] mx-auto rounded-xl shadow-xl overflow-hidden aspect-video bg-gradient-to-br from-brand-blue/90 to-brand-blue flex items-center justify-center relative">
          <motion.button
